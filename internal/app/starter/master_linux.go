...
func startContainer(masterSocket int, containerPid int, engine *engines.Engine, fatalChan chan error) {
...
func Master(rpcSocket, masterSocket int, containerPid int, engine *engines.Engine) {
	...
	go createContainer(rpcSocket, containerPid, engine, fatalChan)

	go startContainer(masterSocket, containerPid, engine, fatalChan)
